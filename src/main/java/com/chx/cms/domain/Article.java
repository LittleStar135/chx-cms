...
public class Article implements Serializable{
	...
	private Integer  hot;//是否热度  1：热门     0：一般
	private Integer  status;//文章审核状态  0：待审  1：通过   -1：驳回
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", summary=" + summary + ", content=" + content + ", picture="
				...
				+ ", updated=" + updated + ", keywords=" + keywords + ", original=" + original + ", channel=" + channel
